            ...
            <main className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 
                ...
                {cardContent.map((card, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className='w-[320px] h-[350px] flex justify-between flex-col gap-3 bg-white py-10 px-5 rounded-xl shadow-lg mb-5 md:mb-40'
                    >
                        ...
                        <Link to={card.link}>
                            <button className='text-[14px] text-left font-bold text-[#4CBB17] mt-5'>
                                {card.msg}
                            </button>
                        </Link>
                    </motion.div>
